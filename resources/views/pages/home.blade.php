    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <x-card href="{{ route('projects') }}" >
            <div class="flex items-center justify-between">
                <div>
                    <p class=" text-sm">{{ t('home.stats.completed_projects') }}</p>
        ...
        <x-card>
            <div class="flex items-center justify-between">
                <div>
                    <p class=" text-sm">{{ t('home.stats.month_visits') }}</p>
                    <p class="text-3xl font-bold  mt-2">{{ $monthVisits }}</p>
                </div>
        ...
        <x-card href="{{ route('certifications') }}">
            <div class="flex items-center justify-between">
                <div>
                    <p class=" text-sm">{{ t('home.stats.skills') }}</p>
        ...
        <x-card>
            <div class="flex items-center justify-between">
                <div>
                    <p class=" text-sm">{{ t('home.stats.contacts_received') }}</p>
                    <p class="text-3xl font-bold  mt-2">{{ $contactsReceivedCount }}</p>
                </div>
