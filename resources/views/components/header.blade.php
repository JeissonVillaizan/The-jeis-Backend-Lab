...
<header class="cardGradient border-b border-blue-900/20 px-6 py-4 shadow-lg dark:bg-[#111827] dark:border-blue-900/30 dark:shadow-none">
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
            ...
            <button id="notifications-button" class="p-2 hover:bg-gray-800 rounded-lg transition-all text-gray-400 relative hover:text-gray-200">
            ...
            <!-- settings button -->
            <a href="{{ route('settings') }}" class="p-2 hover:bg-gray-800 rounded-lg transition-all text-gray-400 hover:text-gray-200    ">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div id="notifications-dropdown" class="absolute right-4 top-16 w-80 cardGradient border border-blue-900/30 rounded-xl shadow-xl z-50 hidden overflow-hidden">
                <div class="px-4 py-3 border-b border-blue-900/20">
                ...
                <div class="p-3">
                    @if($notifications->count() > 0)
                        <ul class="space-y-2 max-h-64 overflow-y-auto pr-1">
                            ...
                            @if ($notification->visibility_status)
                                <li class="p-3 cardGradient border border-blue-900/20 rounded-lg hover:bg-[#0f172a]/60 hover:border-blue-900/40 transition-colors cursor-pointer flex gap-3">
                    ...
                    @else
                        <p class="text-sm text-gray-400 text-center py-6">No notifications available.</p>
                    @endif
                </div>
            </div>
    </div>
