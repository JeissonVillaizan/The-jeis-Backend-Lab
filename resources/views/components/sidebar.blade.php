...
<div id="mobile-sidebar" class="fixed inset-y-0 left-0 z-40 w-64 transform -translate-x-full transition-transform md:hidden">
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.4" d="M12 2l8 4.5v9L12 20l-8-4.5v-9L12 2z"></path>
    <path stroke="currentColor" stroke-width="0.9" stroke-linecap="round" fill="none" d="M13.5 8V13.5H10"></path>
    ...
    <circle cx="10" cy="13.5" r="1" fill="currentColor"></circle>
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                <a href="/" class="flex items-center gap-3 px-4 py-3 rounded-lg text-slate-700 dark:text-slate-300 font-medium transition-all hover:bg-slate-900/10 dark:hover:bg-slate-800/50 hover:text-slate-900 dark:hover:text-white">
                ...
                <a href="{{ route('projects') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-900/10 dark:hover:bg-slate-800/50 transition-all">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('certifications') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-900/10 dark:hover:bg-slate-800/50 transition-all">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('settings') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-900/10 dark:hover:bg-slate-800/50 transition-all">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="px-4 py-4 border-t border-[var(--border)]">
                <div class="flex items-center gap-3 p-3 rounded-lg hover:bg-slate-900/10 dark:hover:bg-slate-800/50 cursor-pointer transition-all">
...
<svg class="w-100 h-10 text-slate-700 dark:text-white" fill="none" viewBox="0 0 24 24">
    ...
    <circle cx="10" cy="13.5" r="1" fill="currentColor"></circle>
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
            ...
            <a href="{{ route('projects') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg  font-medium hover:text-slate-900 dark:hover:text-white hover:bg-slate-900/10 dark:hover:bg-slate-800/50 transition-all {{ request()->routeIs('projects') ? 'bg-slate-900/10 text-slate-800 dark:bg-blue-900/20 dark:text-blue-300' : 'text-slate-600 dark:text-slate-400' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path>
                </svg>
                <span>{{ t('nav.projects') }}</span>
            ...
            <a href="{{ route('settings') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg  font-medium hover:text-slate-900 dark:hover:text-white hover:bg-slate-900/10 dark:hover:bg-slate-800/50 transition-all {{ request()->routeIs('settings') ? 'bg-slate-900/10 text-slate-800 dark:bg-blue-900/20 dark:text-blue-300' : 'text-slate-600 dark:text-slate-400' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path>
                </svg>
                <span>{{ t('nav.settings') }}</span>
