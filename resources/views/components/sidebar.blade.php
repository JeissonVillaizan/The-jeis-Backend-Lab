...
<div id="mobile-sidebar"
    ...
    <aside class="h-full cardGradient bg-white dark:bg-slate-900 shadow-xl">
        <div class="h-full flex flex-col">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                <a href="/"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-all hover:bg-slate-900/10 dark:hover:bg-slate-800/50 hover:text-slate-900 dark:hover:text-white {{ request()->routeIs('dashboard') ? 'bg-slate-900/10 text-slate-800 dark:bg-blue-900/20 dark:text-blue-300' : 'text-slate-600 dark:text-slate-400' }}">
                ...
                <a href="{{ route('projects') }}"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-all hover:bg-slate-900/10 dark:hover:bg-slate-800/50 hover:text-slate-900 dark:hover:text-white {{ request()->routeIs('projects') ? 'bg-slate-900/10 text-slate-800 dark:bg-blue-900/20 dark:text-blue-300' : 'text-slate-600 dark:text-slate-400' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('certifications') }}"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-all hover:bg-slate-900/10 dark:hover:bg-slate-800/50 hover:text-slate-900 dark:hover:text-white {{ request()->routeIs('certifications') ? 'bg-slate-900/10 text-slate-800 dark:bg-blue-900/20 dark:text-blue-300' : 'text-slate-600 dark:text-slate-400' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('settings') }}"
                    class="flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-all hover:bg-slate-900/10 dark:hover:bg-slate-800/50 hover:text-slate-900 dark:hover:text-white {{ request()->routeIs('settings') ? 'bg-slate-900/10 text-slate-800 dark:bg-blue-900/20 dark:text-blue-300' : 'text-slate-600 dark:text-slate-400' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
